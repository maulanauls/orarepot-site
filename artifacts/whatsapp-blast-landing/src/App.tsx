...
const plans = [
  {
    ...
    features: ['Official WABA Meta', 'Unlimited broadcast', 'Anti-banned lebih aman', 'Dashboard'],
  },
  {
    ...
    features: ['Official WABA Meta', 'Dashboard', 'OTP resmi untuk verifikasi', 'WhatsApp Business terpercaya'],
  },
  {
    ...
    features: ['Official WABA Meta', 'Dashboard', 'Unlimited broadcast', 'Anti-banned lebih aman'],
  },
];
...
function TrustStrip() {
  return <div className="trust-strip"><div className="container trust-row"><span className="trust-kicker">Jalur resmi untuk komunikasi yang berarti</span><div className="trust-logos"><span><ShieldCheck size={14} /> Official WABA Meta</span><span><MessageCircle size={14} /> WhatsApp Business API</span><span><LockKeyhole size={14} /> Secure OTP</span></div></div></div>;
}
